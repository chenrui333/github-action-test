...
RUN case $(uname -m) in x86_64|amd64) ARCH="amd64" ;; aarch64|arm64|armv7|armv8) ARCH="arm64" ;; esac && \
...
RUN case $(uname -m) in x86_64|amd64) ARCH="x86_64" ;; aarch64|arm64|armv7|armv8) ARCH="arm64" ;; esac && \
